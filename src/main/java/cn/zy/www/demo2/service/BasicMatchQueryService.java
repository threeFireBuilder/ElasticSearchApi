package cn.zy.www.demo2.service;
...
import cn.zy.www.demo2.utils.CommonQueryUtils;
...
public class BasicMatchQueryService {
    ...
    private String bookIndex = "bookdb_index";

    private String bookType = "book";

    public BasicMatchQueryService() throws UnknownHostException {
    }
     ...
     * 1.1 对 "guide" 执行全文检索
     */
    public Response<List<Book>> multiBatch(Client client,String query) {
        MultiMatchQueryBuilder queryBuilder = new MultiMatchQueryBuilder(query,"title");
     ...
     * 将“摘要”字段的得分提高了3倍 采用boost  加大该字段的权重
     */
     ...
     */
    public Response<List<Book>> wildcard(Client client,String fieldName, String pattern) {
     ...
     */
    public Response<List<Book>> regexp(Client client,String fieldName, String regexp) {
